...
set QA_Backup_Loc=Z:\Backups\quickaccess_backup
...
echo. ......................................................................
echo.
echo. 1 - BACKUP Quick Access Menu from COMPUTER to USER DRIVE (Z:)
echo. 2 - RESTORE Quick Access Menu from USER DRIVE (Z:) to COMPUTER
...
mkdir %QA_Backup_Loc%
echo. ******************************************************************************* >> %log%
echo. *****BACKUP***BACKUP***BACKUP***BACKUP***BACKUP***BACKUP***BACKUP***BACKUP***** >> %log%
echo. >> %log%
...
::Robocopy %Userprofile%\XXXXXX  Z:\XXXXXX\ /MIR /XA:SH /V /TEE /TS /R:1000 > %log%
...
Robocopy %QA_dest% %Userprofile%\Backups\quickaccess_backup /MIR /V /TEE /TS
cd %QA_Backup_Loc%
echo. ******************************************************************************* >> %log%
echo. *RESTORE***RESTORE***RESTORE***RESTORE***RESTORE***RESTORE***RESTORE***RESTORE* >> %log%
echo. >> %log%
echo. Log Location: %log% >> %log%
...
echo.		menu items.
echo.	This will copy your current QA menu items to your user drive: Z:\Backups\quickaccess_backup
...
echo.	This will copy your QA menu items from your user drive (Z:\Backups\quickaccess_backup) to the destination
echo.		computer.
...
::C:\Users\VHAPORFitzsC\AppData\Roaming\Microsoft\Windows\Recent\AutomaticDestinations
